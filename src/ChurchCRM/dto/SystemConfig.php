...
class SystemConfig
{
    ...
    private static function buildConfigs(): array
    {
        return [
            ...
            'sInactiveClassification'              => new ConfigItem(2073, 'sInactiveClassification', 'text', '', gettext('Comma separeted list of classifications that should appear as inactive')),
