...
<footer class="main-footer">
    ...
    <strong><?= gettext('Copyright') ?> &copy; <?= SystemService::getCurrentYear() ?> <a href="https://churchcrm.io" target="_blank"><b>Church</b>CRM</a>.</strong> <?= gettext('All rights reserved') ?>.
